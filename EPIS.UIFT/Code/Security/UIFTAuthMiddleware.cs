...
namespace UIFT.Security
{
    ...
    public class UIFTAuthMiddleware
    {
        ...
        // instance vysledku autentikace
        private AuthorizeRequestResult result = new AuthorizeRequestResult();
        private int a11id = 0;
        ...
        public async Task Invoke(HttpContext context, UIFT.Repository.RepositoryFactory factory, BO.RunningUser runningUser)
        {
            ...
            if (executingEnpoint != null)
            {
                ...
                {
                    // a11id
                    this.a11id = get_a11id(context);

                    // username
                    GetLogin(context, runningUser);
        ...
        private void GetLogin(HttpContext context, BO.RunningUser runningUser)
        {
