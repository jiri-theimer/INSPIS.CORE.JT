...
(function ($) {
    ...
    $.fn.numericInput = function (options) {
        ...
        this.focus(function (e) {
            ...
            if (this.value != "") {
                this.value = format("### ### ### ##0.####", this.value.replace(",", ".")).replace(".", ",");
            }
        }).keypress(function (event) {
            ...
            {
                if (allowFloat == true && inputCode == settings.floatSeparator.charCodeAt(0))	// Conditions for a period (decimal point)
                {
...
;( function( $ ) 
{
    ...
    function Scrollbar( root, options )
    {
        ...
        ,   oContent    = { obj: $( '#segmentsTree', root ) }
