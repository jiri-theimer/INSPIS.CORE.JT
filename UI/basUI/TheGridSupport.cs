...
namespace UI
{
    public class TheGridSupport
    {
        ...
        private void Render_TOTALS(System.Data.DataTable dt)
        {
            ...
            _s.Append(string.Format("<th class='th0' title='{0}' colspan=3 style='width:60px;'><span class='badge badge-primary'>{1}</span></th>", _Factory.tra("Celkový počet záznamů"), string.Format("{0:#,0}", dt.Rows[0]["RowsCount"])));
