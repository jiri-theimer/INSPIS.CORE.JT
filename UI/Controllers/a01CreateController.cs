    ...
    public class a01CreateController : BaseController
    {
        ...
        public IActionResult Injury(a01CreateInjuryViewModel v)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                BO.a01Event c = new BO.a01Event() {a01DateFrom=DateTime.Today, a01IsTemporary = true, a10ID = v.a10ID, a03ID = v.a03ID, j03ID_Creator = Factory.CurrentUser.pid, j02ID_Issuer = Factory.CurrentUser.j02ID, a01TemporaryFlag=BO.a01TemporaryFlagENUM._None };
