...
Public Class Evaluator
    ...
    Public Function TryEval(str As String) As Object ''Implements IEvaluatorBL.TryEval
        ...
        Catch ex As Exception
            _Error = ex.Message
            'log4net.LogManager.GetLogger("evaluatorlog").Error("Expression: " & str & GetLogOcas(), ex)
            Return Nothing
        End Try
    End Function

    Private Function GetLogOcas() As String
        Return vbCrLf & "a11ID: " & _A11ID.ToString & vbCrLf & "User: " & _ServiceUser.j03Login & " (" & _ServiceUser.pid.ToString & ")"
    End Function
            ...
            Do
                Select Case tokenizer.type
                    Case eTokenType.operator_minus
                        ...
                        Else
                            tokenizer.RaiseWrongOperator(eTokenType.operator_minus, ValueLeft, Nothing,
                    ...
                    Case eTokenType.operator_not
                        ...
                        Else
                            tokenizer.RaiseWrongOperator(eTokenType.operator_not, ValueLeft, Nothing,
                ...
                Select Case tt
                    ...
                    Case eTokenType.operator_ne, eTokenType.operator_gt, eTokenType.operator_ge, eTokenType.operator_eq, eTokenType.operator_le, eTokenType.operator_lt
                        If priority < ePriority.equality Then
                            ...
                            If TypeOf ValueLeft Is IComparable AndAlso
        ...
        Private Function InternalGetVariable() As Object
            ...
            Do
                ...
                If CurrentObject Is Nothing Then
                    ...
                    mi = CurrentObject.GetType().GetMethod(
                       func)
