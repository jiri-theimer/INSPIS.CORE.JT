...
namespace BL
{
    public interface IDataGridBL
    {
        ...
        public int SaveTheGridState(BO.j72TheGridState rec, List<BO.j73TheGridQuery> lisJ73, List<int> j04ids, List<int> j11ids);
    ...
    class DataGridBL:BaseBL,IDataGridBL
    {
        ...
        {            
            ...
            if (mq.explicit_columns == null || mq.explicit_columns.Count()==0)
            {
                ...
                mq.explicit_columns = new BL.TheColumnsProvider(_mother.App,_mother.EProvider).getDefaultPallete(false,mq);    //na vstupu není přesný výčet sloupců -> pracovat s default sadou
            }
            if (bolGetTotalsRow)
            {
