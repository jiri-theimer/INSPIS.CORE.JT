...
namespace BL
{
    ...
    class b06WorkflowStepBL : BaseBL, Ib06WorkflowStepBL
    {
        ...
        public IEnumerable<BO.b10WorkflowCommandCatalog_Binding> GetListB10(int b06id)
        {
            sb("SELECT a.*,b09.b09ParametersCount,b09.b09SQL,b02.b02Name as b02Name_TargetUpdate,a10.a10Name as a10Name_TargetUpdate,b09.b09Ident,");
            sb("b09.b09Name,b09.b09Name_Lang2,");
